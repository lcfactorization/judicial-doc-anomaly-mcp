...
from .prompts import DIMENSION_PROMPTS, ADVERSARIAL_PROMPT, REPORT_TEMPLATE
...
"""
    ...
    def _generate_report(self, result: DetectionResult) -> str:
        ...
        return REPORT_TEMPLATE.format(
            ...
            timeline_table="| - | - | - |",
            temporal_anomalies="暂无时间异常分析",
            semantic_drift_table="暂无语义漂移分析",
            negative_space_analysis="暂无负空间分析",
            deviation_table="暂无类案偏离分析",
            procedure_graph_text="暂无程序图分析",
            mermaid_graph="",
            anomaly_paths="暂无异常路径分析",
            adversarial_table="未执行对抗审查",
            quality_score_table="未执行质量评估",
            quality_total_score="-",
            quality_grade="-",
            quality_strengths="-",
            quality_weaknesses="-",
